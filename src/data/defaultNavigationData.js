...
export const defaultMainNavigation = [
  ...
  { id: "nav_learning_corner", label: "🎮 ركن التعلم", type: "page", target: "learning-corner", category: "main", order: 3 },
  { id: "nav_2", label: "المبادرات", type: "section", target: "initiatives", category: "main", order: 4 },
  { id: "nav_challenge", label: "🏆 التحدي الأسبوعي", type: "page", target: "challenge", category: "main", order: 5 },
  { id: "nav_worksheets", label: "📑 أوراق العمل", type: "page", target: "worksheets", category: "main", order: 6 },
  { id: "nav_articles", label: "📚 مقالات علمية", type: "page", target: "articles", category: "main", order: 7 },
  ...
  { id: "nav_4", label: "الأخبار", type: "section", target: "news", category: "main", order: 10 },
  { id: "nav_5", label: "🎓 كلمة المدير", type: "page", target: "principal", category: "main", order: 11 }
];
