...
const AiAssistant = () => {
  ...
  const handleSendMessage = async (textToSend) => {
    ...
    try {
      ...
      let fallbackReply = 'أهلاً بك! أنا مساعد مدرسة مشيرفة الابتدائية. يسعدني إجابتك حول المدرسة: المدير هو الأستاذ رامي ارفاعية، ويمكنك الاطلاع على الكتب واللباس الموحد والرزنامة من أقسام الموقع المخصصة. كيف يمكنني مساعدتك أكثر؟ 😊';
