...
const STATIONS_DATA = [
  {
    ...
    time45: '5 - 7 دقائق',
    time90: '10 - 12 دقيقة',
    goal: 'إثارة الاهتمام، وتنشيط المعرفة السابقة، وطرح سؤال يرتبط بهدف التعلّم.',
    focusCognitive: 'استدعاء المعرفة السابقة وطرح الأسئلة',
    studentQuestion: 'ما الذي يثير فضولي؟ وما الذي نريد استكشافه؟',
    practices: [
      'عرض مثير قصير ذي صلة: صورة، أو غرض محسوس، أو قصة، أو ظاهرة، أو مشكلة، أو خطأ لافت.',
      'تأمّل الطلاب وربط ما يشاهدونه بمعرفتهم السابقة واقتراح أسئلة أو فرضيات.',
      'البدء بسؤال ميسّر: «ماذا لاحظتم؟»، ثم دعوة الطلاب إلى تقديم تفسيرات أكثر تعقيدًا.',
      'إتاحة طرائق تعبير متنوعة: كلام، إشارة، رسم، أو حوار ثنائي.'
    ],
    inclusion: 'عرض المثير بصورة ميسّرة (صورة مصحوبة بوصف لفظي، أو نص مع استماع). إتاحة الاستجابة بالكلام أو الإشارة أو الرسم أو الحوار الثنائي لحفظ كرامة وأمان الطالب.',
    differentiation: 'تقديم دعم لغوي، وقت للتفكير، كلمات مساعدة، أو أسئلة متابعة بحسب الحاجة. ودعوة الطلاب المستعدّين للتوسّع إلى تقديم فرضية وتعليلها.',
    evaluation: 'يصغي المعلم إلى الاستجابات لتحديد المعرفة السابقة، والأسئلة، والتصوّرات الأولية لتكييف الشرح اللاحق.',
    teacherRole: 'ميسّر وموجّه — يطرح المثير الميسّر ويصغي للتصورات الأولية دون حرق الحل.',
    studentRole: 'متأمّل، مستكشف، يطرح الأسئلة والفرضيات ويعبّر بطريقته المناسبة.',
    transitionSign: 'يستطيع الطلاب تحديد الموضوع الذي سيتناولونه أو ما يسعون إلى استكشافه، بطريقة تعبير مناسبة لهم.',
    transitionPhrase: '«انطلاقًا مما طرحتموه، سنحاول اليوم أن نفهم…»',
    example: {
      subject: 'علوم وتكنولوجيا',
      action: 'عرض صورة لظاهرة طبيعية غير مألوفة، وسؤال الطلاب: «ماذا لاحظتم؟»، وجمع تساؤلاتهم الأولية للانطلاق في الدرس.'
    }
  },
  {
    id: 'f',
    ...
    time45: '8 - 10 دقائق',
    time90: '15 - 18 دقيقة',
    goal: 'توضيح هدف التعلّم وبناء فهم أوّلي للمفاهيم وطرائق العمل.',
    focusCognitive: 'التذكّر والفهم',
    studentQuestion: 'ماذا نتعلّم؟ وكيف أشرح الفكرة بكلماتي الخاصة؟',
    practices: [
      'عرض هدف التعلّم بلغة مفهومة وإبقائه ظاهرًا للطلاب مع معايير نجاح موجزة.',
      'شرح المعلم وتقديم نماذج توضيحية ونمذجة خطوات التفكير بصوت مسموع (I Do).',
      'قراءة الطلاب، والاستماع، والتجريب، وطرح الأسئلة، والشرح بكلماتهم الخاصة.',
      'توفير معجم صفي موجز للمفاهيم الأساسية مع مثال أو رمز مساعد (رف المفاتيح).'
    ],
    inclusion: 'استخدام تمثيلات متكاملة: شرح لفظي، مخطّط، عرض عملي، أو غرض محسوس. وصياغة التعليمات بوضوح في أجزاء مناسبة للمهمة.',
    differentiation: 'تكييف عدد الأمثلة، طريقة الإيضاح، ومدى تجزئة المهمة إلى خطوات (تقديم مثال محلول، بطاقة خطوات، أو شرح إضافي ضمن مجموعة صغيرة).',
    evaluation: 'طلب شاهد موجز على الفهم من كل طالب: مثال، تصنيف، عرض عملي، أو شرح لتحديد من يتابع ومن يحتاج ترسيخاً.',
    teacherRole: 'شارح ونموذج وموجّه — يوضح المفاهيم ويعرض خطوات التفكير بصوت مسموع.',
    studentRole: 'مشارك نشط — يستمع، يسأل، ويشرح الفكرة الأساسية أو يوضّחها عمليًا بكلماته الخاصة.',
    transitionSign: 'يشرح الطالب الفكرة الأساسية أو يوضّحها عمليًا. وعندما يحتاج إلى مساعدة، يُحدَّد الدعم الذي يمكّنه من المتابعة.',
    transitionPhrase: '«تعرّفنا إلى الفكرة؛ والآن سنفحص كيف تعمل ولماذا»',
    example: {
      subject: 'لغة عربية / علوم',
      action: 'كتابة الهدف ومعايير النجاح على اللوح، تقديم نمذجة حية، والتحقق من فهم الطلاب عبر بطاقات التصنيف والمصطلحات.'
    }
  },
  {
    id: 't',
    ...
    time45: '8 - 10 دقائق',
    time90: '18 - 20 دقيقة',
    goal: 'فحص العلاقات والتفسيرات والأدلة، وتعميق الفهم.',
    focusCognitive: 'التحليل، وفحص الأدلة، وإصدار أحكام معلَّلة',
    studentQuestion: 'كيف توصّلت إلى الإجابة؟ وما الذي يدعمها؟',
    practices: [
      'طرح أسئلة تفكير عليا: «كيف توصّلت إلى الاستنتاج؟»، «ما العلاقة بين الأجزاء؟»، «ما الدليل؟»، «ما الذي سيتغيّر إذا غيّرنا المعطيات؟».',
      'تحليل الطلاب، والمقارنة، والتعليل، وفحص التفسيرات البديلة وتعديل الموقف مع ظهور معلومات جديدة.',
      'توزيع أدوار متناوبة في المجموعات (الباحث عن الأدلة، مقدّم التعليل، المتحدّث) مع تعبير كل طالب عن فهمه الشخصي.',
      'توظيف منظمات التفكير وقوالب صياغة الادعاء والدليل.'
    ],
    inclusion: 'إتاحة وقت للتفكير الفردي قبل الحوار، والعمل في أزواج أو مجموعات ثلاثية بتشكيل يناسب المهمة، وتوفير بطاقات تلميح.',
    differentiation: 'أسئلة مساعدة وبطاقات تلميح للمحتاجين، ودعوة الطلاب المستعدّين للتوسّع لفحص ادّعاء مضاد، أو حالة استثنائية، أو تفسير بديل.',
    evaluation: 'فحص جودة التعليل والعلاقة والدليل، والتحقق من فهم كل طالب حتى لو كان المنتج جماعياً: «اختاروا دليلًا واحدًا واشرحوا كيف يدعم الإجابة».',
    teacherRole: 'محفّز فكري وميسّر للحوار — يطرح أسئلة التفكير ويدير الحوار دون إعطاء إجابات مسبقة.',
    studentRole: 'محلل، باحث عن أدلة، يعلل إجابته ويقدم تفسيراً مبرراً مع الدعم المناسب له.',
    transitionSign: 'يقدّم الطالب تفسيرًا معلَّلًا أو يبيّن علاقة ذات معنى، مع الدعم المناسب له.',
    transitionPhrase: '«فحصنا الفكرة وفسّرناها؛ والآن سنستخدمها في المهمة»',
    example: {
      subject: 'مهارات التفكير والبحث',
      action: 'فحص فرضيتين متباينتين، استخراج دليل يدعم كل فرضية، ومناقشة أثر تغيير أحد المتغيرات.'
    }
  },
  {
    id: 'y',
    ...
    time45: '12 - 15 دقيقة',
    time90: '25 - 35 دقيقة',
    goal: 'استخدام المعارف والمهارات من خلال التدريب، وحل المشكلات، وإنتاج المخرجات.',
    focusCognitive: 'التطبيق، والإبداع في المهمات الملائمة',
    studentQuestion: 'كيف أستخدم ما تعلّمته؟ وما الأدوات التي تساعدني؟',
    practices: [
      'عرض المهمة ومعايير النجاح، والعمل الفردي أو الثنائي أو الجماعي.',
      'تفعيل 3 مسارات عمل مرنة: تطبيق مدعوم، تطبيق مستقل، وتعمّق وإبداع.',
      'تفعيل طاولة التدريس المركّز («محطة الضبط والإتقان») لمجموعة متغيّرة من 4-6 طلاب لترسيخ المفاهيم بتدريب موجّه.',
      'استخدام بطاقة «مفتاح العودة إلى الفهم» لطلب التوضيح ومساندة الزميل الميسّر.'
    ],
    inclusion: 'إتاحة طرائق متعددة للأداء: كتابة، شرح مسجل، مخطط، رسم مفسر، مجسم، أو عرض عملي يثبت تحقيق هدف التعلم.',
    differentiation: 'مسارات متمايزة ومرنة: (1) مسار مدعوم (مثال محلول، بنك كلمات، بطاقة خطوات) (2) مسار مستقل (مهمات أساسية) (3) مسار تعمق وإبداع (تحليل خطأ، مقارنة حلول، تخطيط جديد).',
    evaluation: 'فحص المنتج وطريقة الأداء وفق المعايير، مع توثيق نوع الدعم ودرجة الاستقلالية.',
    teacherRole: 'مدرّب ومتابع — يدير طاولة التدريس المركز ويتنقل لتقديم الدعم ومتابعة المسارات.',
    studentRole: 'مطبّق ومبدع — ينجز المهمة عبر مساره، يستعين برَف المفاتيح، أو يطلب المساعدة عبر البطاقة.',
    transitionSign: 'يُظهر الطالب استخدامًا لما تعلّمه، ويشرح طريقة عمله.',
    transitionPhrase: '«سنفحص الآن ما نجحنا في إنجازه، وما نريد أن نحمله معنا للمرحلة المقبلة»',
    example: {
      subject: 'ورشة تطبيقية متمايزة',
      action: 'توزيع الطلاب على المسارات الثلاثة مع إتاحة أدوات رف المفاتيح وعمل المعلم مع مجموعة طاولة الضبط والإتقان.'
    }
  },
  {
    id: 'h',
    ...
    time45: '4 - 5 دقائق',
    time90: '8 - 10 دقائق',
    goal: 'العودة إلى الهدف، وتحديد التقدّم، واختيار زوّادة لمواصلة التعلّم.',
    focusCognitive: 'التقويم الذاتي والتأمل في التعلّم',
    studentQuestion: 'فيمَ تقدّمت؟ وما الذي سأحمله معي للمرحلة المقبلة؟',
    practices: [
      'إجابة الطالب عن الأسئلة الخمسة للتأمل الذاتي (ماذا تعلّمت؟ ما الدليل؟ ما الذي ساعدني؟ ما الذي يحتاج تدريباً؟ أين سأستخدمه؟).',
      'تدوين خانة "زوّادتي" في دفتر التعلم أو بطاقة الحصاد (معرفة، مهارة، استراتيجية، أو سؤال).',
      'مشاركة فردية أو ثنائية موجزة تُظهر أثر التعلم ونقله للحياة.',
      'ترديد وتطبيق مقولة الطالب: «أعرف ما أتعلّمه، وأجد طريقة للمشاركة، وأطلب المساعدة حين أحتاج إليها، وأُظهر كيف تقدّمت».'
    ],
    inclusion: 'إتاحة التلخيص بالكتابة أو الكلام أو الرسم أو الاختيار المصحوب بتفسير، مع إمكانية المشاركة الفردية دون إحراج الطالب.',
    differentiation: 'تكييف حجم التلخيص والدعم (طالب يستعين ببداية جملة، وطالب يشرح كيف سينقل التعلم لموقف جديد).',
    evaluation: 'فحص الطالب لتقدمه مقارنة بنقطة بدايته ومعايير النجاح، واستخدام المعلم للبيانات لتخطيط المراجعة والدعم والتعمق.',
    teacherRole: 'مستمع ومصادق وموثق للزوائد الفكرية والقيمية للطلاب ومخطط للخطوة التالية.',
    studentRole: 'مقيّم ذاتي، يحدد ما تعلمه، يقدم شاهداً عليه، ويختار زوّادته لمواصلة التعلم.',
    transitionSign: 'يحدّد الطالب ما تعلّمه، ويقدّم شاهدًا عليه، ويشير إلى خطوة لاحقة أو استخدام ممكن.',
    transitionPhrase: '«مِفتاح — مسار تعلّم مشترك، وطرائق متنوّعة للمشاركة والتقدّم.»',
    example: {
      subject: 'دفتر «زوّادتي»',
      action: 'يكتب الطالب سطرين: "ما تعلمته اليوم وما الذي ساعدني، وكيف سأوظفه في حياتي اليومية".'
    }
  }
];
...
${p.stations?.h || ''}
  ...
  const handleAskRobot = async (query) => {
    ...
    try {
      const systemContext = `أنت "المستشار البيداغوجي الذكي لنموذج مِفتاح (מודל מפתיח)" بمدرسة مشيرفة الابتدائية.
...
المبادئ الثلاثة الممتدة عبر النموذج:
1. الاحتواء والدمج (הכלה והשתלבות): لكل طالب مكان ومساهمة، مداخل ميسّرة، تمثيلات متعددة UDL، بدائل تعبيرية، حوار ثنائي، وحفظ كرامة الطالب.
2. التعليم المتمايز (הוראה דיפרנציאלית): استجابة متغيّرة بحسب الحاجة، 3 مسارات عمل مرنة في الورشة (مدعوم، مستقل، تعمّق وإبداع)، طاولة التدريس المركّز («محطة الضبط والإتقان» 4-6 طلاب)، وبطاقة «مفتاح العودة إلى الفهم».
3. التقويم (הערכה): معلومات توجّه الخطوة التالية، شواهد فهم موجزة ومؤشرات تقدم، ومعايير نجاح في 3 أبعاد (المحتوى، المهارة، المشاركة).

المحطات الخمس وعبارات الانتقال الإلزامية:
[ م ] مدخل محفّز (משיכה וסקרנות) — استدعاء المعرفة السابقة وطرح الأسئلة: «ما الذي يثير فضولي؟ وما الذي نريد استكشافه؟» -> الانتقال: «انطلاقًا مما طرحتموه، سنحاول اليوم أن نفهم…»
[ ف ] فهم وبناء المعنى (פיתוח הבנה) — التذكّر والفهم، معجم المفاهيم ونمذجة المعلم: «ماذا نتعلّم؟ وكيف أشرح الفكرة بكلماتي الخاصة؟» -> الانتقال: «تعرّفنا إلى الفكرة؛ والآن سنفحص كيف تعمل ولماذا»
[ ت ] تفكير وتبصّر (תובנה והעמקה) — التحليل وفحص الأدلة وأدوار المجموعات: «كيف توصّلت إلى الإجابة؟ وما الذي يدعمها؟» -> الانتقال: «فحصنا الفكرة وفسّرناها؛ والآن سنستخدمها في المهمة»
[ ي ] إنجاز وتطبيق (יצירה ויישום) — الورشة والمسارات الثلاثة، طاولة التدريس المركّز وبطاقة مفتاح العودة: «كيف أستخدم ما تعلّمته؟ وما الأدوات التي تساعدني؟» -> الانتقال: «سنفحص الآن ما نجحنا في إنجازه، وما نريد أن نحمله معنا للمرحلة المقبلة»
[ ح ] حصاد وزوّادة (חתימה וצידה לדרך) — التقويم الذاتي عبر الأسئلة الخمسة وتحديد الزوّادة ومقولة الطالب: «أعرف ما أتعلّمه، وأجد طريقة للمشاركة، وأطلب المساعدة حين أحتاج إليها، وأُظهر كيف تقدّمت».

⭐ توجيه إلزامي:
عند اقتراح خطة أو الإجابة عن أسئلة المعلمين، وضح دائماً المحطات الخمس وقدم أمثلة تطبيقية صريحة على (1) الاحتواء والدمج הכלה והשתלבות، (2) التعليم المتمايز דיפרנציאליות، و(3) التقويم وشواهد الفهم הערכה في كل مرحلة ومحطة.`;
      ...
      if (lower.includes('دمج') || lower.includes('احتواء') || lower.includes('הכלה') || lower.includes('تمايز') || lower.includes('דיפרנציאלי') || lower.includes('تقويم') || lower.includes('הערכה') || lower.includes('مثال') || lower.includes('דוגמה')) {
        setRobotReply(`🌟 دليل الأمثلة التطبيقية للمبادئ الثلاثة (הכלה | דיפרנציאליות | הערכה) عبر المحطات الخمس لموديل مِفتاح:

1️⃣ [ م ] مدخل محفّز (משיכה וסקרנות):
• 🤝 الاحتواء والدمج (הכלה והשתלבות): سؤال انطلاق عيني ميسر («ماذا تشاهدون في هذه الصورة؟»)، وبدائل استجابة (إشارة، رسم، حوار ثنائي) لمشاركة طالب الدمج دون خوف من التقييم.
• 🔀 التعليم المتمايز (דיפרנציאליות): مثير حسي متعدد القنوات (بصري وملموس) وسؤال مفتوح يقبل إجابات متباينة العمق.
• 📊 التقويم (הערכה): تقويم تشخيصي؛ مسح سريع للفرضيات لتحديد المفاهيم الخاطئة وتوجيه مسار الحصة.

2️⃣ [ ف ] فهم وبناء المعنى (פיתוח הבנה):
• 🤝 الاحتواء والدمج (הכלה והשתلבות): تمثيلات UDL متعددة، بنك كلمات معزز بالصور، ودور ميسر لمعلمة الدمج دون لفت الانتباه.
• 🔀 التعليم المتمايز (דיפרנציאליות): بطاقات خطوات مرقمة (Scaffolding)، ومهمة تفسير تعليلية موازية للطلاب المتفوقين.
• 📊 التقويم (הערכה): فحص فهم سريع (Checking for Understanding) بإشارة الأصابع أو صياغة المفهوم بلغة الطالب الخاصة قبل الانتقال.

3️⃣ [ ت ] تفكير وتبصّر (תובנה והעמקה):
• 🤝 الاحتواء والدمج (הכלה והשתلבות): وقت تفكير فردي صامت (Think Time)، وأدوار محددة متناوبة بالمجموعات لضمان مساهمة مقدرة لطالب الصعوبات.
• 🔀 التعليم المتمايز (דיפרנציאליות): تدرج في أسئلة التفكير العليا؛ من المقارنة المباشرة إلى فحص ادعاء مضاد وتبرير التفسير.
• 📊 التقويم (הערכה): بطاقة «الدليل والتعليل» لفحص البرهنة وتعديل التوجيه فوراً.

4️⃣ [ ي ] إنجاز وتطبيق (יצירה ויישום):
• 🤝 الاحتواء والدمج (הכלה והשתلבות): طاولة التدريس المركّز («محطة الضبط والإتقان» 4-6 طلاب مع المعلم)، بطاقة «مفتاح العودة»، وتنويع وسيط الإنتاج.
• 🔀 التعليم المتمايز (דיפרנציאליות): 3 مسارات عمل مرنة (مدعوم، مستقل، تعمّق وإبداع) بمهام واضحة لكل مسار.
• 📊 التقويم (הערכה): تقويم تكويني مستمر وفق معايير النجاح ثلاثية الأبعاد (محتوى، مهارة، مشاركة).

5️⃣ [ ح ] حصاد وزوّادة (חתימה וצידה לדרך):
• 🤝 الاحتواء والدمج (הכלה והשתلבות): خيارات مرنة لتذكرة الخروج (كتابة سطر، تسجيل صوتي، أو تلوين مقياس إنجاز)، وخروج كل طالب بكرامة وشعور بالنجاح.
• 🔀 التعليم المتمايز (דיפרנציאליות): زوّادة موجهة (تثبيت المفهوم الأساسي لطالب يحتاج دعماً، أو سؤال استكشافي مستقبلي للمتفوقين).
• 📊 التقويم (הערכה): تذكرة الخروج (Exit Ticket) وفق الأسئلة الخمسة لرصد انتقال أثر التعلم وتخطيط الدرس التالي.`);
      } else if (lower.includes('مدخل') || lower.includes('محفز') || lower.includes('جذب') || lower.includes('تشويق') || lower.includes('סקרנות') || lower.includes('משיכה')) {
        setRobotReply('💡 نصيحة لمحطة المدخل المحفّز [ م ] (משיכה וסקרנות):\nلا تكشف الإجابة أو الحل! اطرح لغزاً أو صورة محيرة أو مشهداً مألوفاً لكسر الجمود. سؤال الطالب: «ما الذي يثير فضولي؟ وما الذي نريد استكشافه؟». والانتقال الإلزامي: «انطلاقًا مما طرحتموه، سنحاول اليوم أن نفهم…».');
      } else if (lower.includes('فهم') || lower.includes('معنى') || lower.includes('مفهوم') || lower.includes('הבנה')) {
        setRobotReply('📖 نصيحة لمحطة فهم وبناء المعنى [ ف ] (פיתוח הבנה):\nركز على المفهوم المركزي بدقة، وثبّته في رف المفاتيح والمعجم الصفي. قدّم نمذجة واضحة (I Do) واطلب من الطلاب إعادة صياغة المفهوم بلغتهم الخاصة. عبارة الانتقال: «تعرّفنا إلى الفكرة؛ والآن سنفحص كيف تعمل ولماذا».');
      } else if (lower.includes('تفكير') || lower.includes('تبصر') || lower.includes('تعمق') || lower.includes('תובנה') || lower.includes('העמקה')) {
        setRobotReply('🧠 نصيحة لمحطة التفكير والتبصّر [ ت ] (תובנה והעמקה):\nاستخدم أسئلة تفكير عليا صريحة (HOTS) مثل: "كيف توصلت للاستنتاج؟ وما الدليل؟ وما الذي سيتغير لو غيرنا المعطيات؟". وزع الأدوار في المجموعات بالتناوب. والانتقال الإلزامي: «فحصنا الفكرة وفسّرناها؛ والآن سنستخدمها في المهمة».');
        ...
        setRobotReply('🛠️ نصيحة لمحطة الإنجاز والتطبيق [ ي ] (יצירה ויישום):\nهنا قلب الورشة والتمايز! خصص 3 مسارات عمل مرنة (مدعوم، مستقل، تعمق وإبداع)، وقُد طاولة التدريس المركّز («محطة الضبط والإتقان» 4-6 طلاب) مع بطاقة «مفتاح العودة إلى الفهم» والزميل المساند.');
      } else if (lower.includes('حصاد') || lower.includes('زوادة') || lower.includes('تذكرة') || lower.includes('חתימה') || lower.includes('צידה')) {
        setRobotReply('🎒 سر "الزوّادة والحصاد" [ ح ] (חתימה וצידה לדרך):\nالحصة لا تنتهي برنين الجرس! بل بالأسئلة الخمسة للتأمل والتقويم الذاتي وتحديد الزوّادة الصريحة. واختم دائماً بمقولة الطالب: «أعرف ما أتعلّمه، وأجد طريقة للمشاركة، وأطلب المساعدة حين أحتاج إليها، وأُظهر كيف تقدّمت».');
      } else if (lower.includes('مسطرة') || lower.includes('وقت') || lower.includes('זמן')) {
        setRobotReply('⏱️ نصيحة لمسطرة الحصة:\nفي الحصة العادية (45 دقيقة): امنح المدخل المحفّز 5د، الفهم وبناء المعنى 10د، التفكير والتبصّر 8د، الإنجاز والتطبيق 15د، والزوّادة 7د. وفي الحصة المضاعفة (90د) وسّع وقت ورشة العمل التطبيقية إلى 35 دقيقة!');
      } else if (lower.includes('عاطفي') || lower.includes('اجتماعي') || lower.includes('sel') || lower.includes('مشاعر') || lower.includes('רגשי')) {
        setRobotReply('❤️ هندسة الدروس في المجال العاطفي والاجتماعي (SEL وفق CASEL):\n• في [ م ]: فحص الطقس الداخلي للمشاعر (Emotional Check-in) وقارورة الهدوء.\n• في [ ف ]: قراءة نصوص غنية بالمشاعر وقاموس تسمية الانفعالات بدقة، ونمذجة الاستماع الصادق.\n• في [ ت ]: أسئلة تبني منظور الآخر (Perspective-Taking) والتفريق بين الاندفاع والهدوء.\n• في [ ي ]: لعب الأدوار (Role-Play) وصياغة مواثيق الأمان النفسي وشجرة المودة بمسارات UDL.\n• في [ ح ]: زوّادة قلبية وسلوكية صريحة يقدمها الطالب لأسرته وبيته اليوم.');
      } else {
        setRobotReply(`رائع جداً! استفسارك حول "${q}" يرتبط بجوهر نموذج مِفتاح (מודל מפתיח). تذكر دائماً أن المفتاح يفتح أبواب التفكير، وأن نجاح الحصة يكمن في دمج الاحتواء والدمج (הכלה)، والتعليم المتمايز (דיפרנציאליות)، والتقويم المستمر (הערכה) في كل محطة من المحطات الخمس!`);
      }
    } finally {
          ...
          <section className="full-document-section fade-in" id="mafatih-doc-top">
            ...
            <div className="doc-paper-header-box">
              <div className="doc-paper-badge-row">
                ...
                <span className="doc-badge-sub">מודל מפתיח — نموذج مِفتاح</span>
                <span className="doc-badge-school">مدرسة مشيرفة الابتدائية</span>
              </div>
              
              <h1 className="doc-paper-title">
                نموذج مِفتاح — מודל מפתיח
              </h1>
              <p className="doc-paper-subtitle">
                إطار مدرسي لبناء لغة تربوية مشتركة، وتعزيز شراكة الطلاب، وتعلّم يدمج الاحتواء والدمج، والتعليم المتمايز، والتقويم — مدرسة مشيرفة الابتدائية
              </p>
              ...
              <div className="doc-controls-bar no-print">
                <div className="doc-jump-chips">
                  ...
                  <a href="#doc-sec-core" className="jump-chip">1. الفكرة والهدفان</a>
                  <a href="#doc-sec-principles" className="jump-chip">2. المبادئ والمرتكزات</a>
                  <a href="#doc-sec-glance" className="jump-chip">3. المحطات في نظرة واحدة</a>
                  <a href="#doc-sec-stations-detail" className="jump-chip">4. الدليل الإجرائي للمحطات</a>
                  <a href="#doc-sec-shared" className="jump-chip">5. المرتكزات ومعايير النجاح</a>
                  <a href="#doc-sec-tools-plan" className="jump-chip">6. أدوات العمل وخطة التطبيق</a>
                </div>
            ...
            <div className="doc-paper-content">
              ...
              {/* CHAPTER 1: الفكرة المحورية والهدفان الرئيسيان */}
              <article className="doc-chapter-card" id="doc-sec-core">
                <div className="chapter-header">
                  <div className="chapter-number-pill">الفصل 1</div>
                  <h2>الفكرة المحورية والهدفان الرئيسيان للنموذج</h2>
                </div>

                <div className="doc-sub-block">
                  <h3 className="doc-sub-title">🔑 الفكرة المحورية</h3>
                  <p className="doc-paragraph leading">
                    نموذج «مِفتاح» هو إطار لتخطيط التدريس وجعل عملية التعلّم واضحة ومفهومة للطلاب. يقوم على خمس محطات: <strong>مدخل محفّز، فهم وبناء المعنى، تفكير وتبصّر، إنجاز وتطبيق، وحصاد وزوّادة.</strong>
                  </p>
                  <p className="doc-paragraph">
                    توفّر هذه المحطات لغة مشتركة للمعلمين والطلاب؛ إذ يستعين بها المعلم لتخطيط التعلّم، بينما يفهم الطالب ما يتعلّمه، والهدف من النشاط، وكيف يمكنه المشاركة، وكيف يتعرّف إلى تقدّمه.
                  </p>
                  <p className="doc-paragraph">
                    المسار مشترك، لكن طرائق المشاركة والدعم والتقدّم متنوّعة. يستطيع الطلاب العمل بطرائق مختلفة، والاستعانة بأدوات متنوّعة، والعودة إلى محطة سابقة بحسب الحاجة.
                  </p>
                  <div className="doc-highlight-quote">
                    <i className="fas fa-key quote-icon"></i>
                    <div>
                      <strong>رمزية المفتاح ودور المعلم والطالب:</strong> يرمز المفتاح إلى فتح أبواب التعلّم. ويتمثّل دور المعلم في تخطيط مداخل ميسّرة للتعلّم، وتقديم التوجيه والتحدّي المناسب؛ بينما يتطوّر دور الطالب تدريجيًا نحو المشاركة الفاعلة، والاختيار الواعي، وطلب المساعدة، وتقويم تقدّمه.
                    </div>
                  </div>
                </div>

                <div className="doc-sub-block">
                  <h3 className="doc-sub-title">🎯 الهدفان الرئيسيان للنموذج</h3>
                  <div className="doc-dual-cards-grid">
                    <div className="dc-card">
                      <div className="dc-badge">1</div>
                      <div className="dc-content">
                        <h4>بناء لغة تربوية مشتركة</h4>
                        <p>استخدام أسماء موحّدة للمحطات، وأسئلة موجِّهة، وأدوات مشتركة للتخطيط والتغذية الراجعة، في مختلف الصفوف والمباحث الدراسية.</p>
                      </div>
                    </div>
                    <div className="dc-card">
                      <div className="dc-badge">2</div>
                      <div className="dc-content">
                        <h4>إشراك الطالب في سير الدرس</h4>
                        <p>تمكينه من فهم هدف التعلّم ومساره، والمشاركة في اتخاذ قرارات مناسبة لعمره، ومتابعة تقدّمه والتخطيط لخطوته التالية.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* CHAPTER 2: ثلاثة مبادئ ممتدة والمرتكزات التربوية */}
              <article className="doc-chapter-card" id="doc-sec-principles">
                <div className="chapter-header">
                  <div className="chapter-number-pill">الفصل 2</div>
                  <h2>ثلاثة مبادئ ممتدة عبر النموذج والمرتكزات التربوية</h2>
                </div>

                <div className="doc-sub-block">
                  <h3 className="doc-sub-title">🌱 المبادئ الثلاثة الممتدة</h3>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '15px', marginTop: '10px' }}>
                    
                    <div style={{ background: '#f8fafc', padding: '1.4rem', borderRadius: '14px', border: '1px solid #e2e8f0', borderTop: '4px solid #3b82f6' }}>
                      <h4 style={{ margin: '0 0 0.6rem 0', color: '#1e40af', fontSize: '1.1rem', fontWeight: '800' }}>
                        1. الاحتواء والدمج — لكل طالب مكان ومساهمة
                      </h4>
                      <p style={{ margin: 0, color: '#334155', fontSize: '0.96rem', lineHeight: '1.75' }}>
                        تُخطَّط في كل محطة، بصورة مسبقة، طرائق تمكّن الطلاب من الوصول إلى المحتوى، والمشاركة، والتعبير عن فهمهم. ويراعي التخطيط الطلاب الذين يتلقّون خدمات التربية الخاصة، والذين يواجهون صعوبات انفعالية، أو صعوبات تعلّم، أو فجوات لغوية. تُتاح لكل طالب فرصة لتقديم مساهمة حقيقية وطرائق آمنة للمشاركة تشمل وقتًا للتحضير، والحوار الثنائي، وطلب المساعدة بطريقة تحفظ كرامة الطالب.
                      </p>
                    </div>

                    <div style={{ background: '#f8fafc', padding: '1.4rem', borderRadius: '14px', border: '1px solid #e2e8f0', borderTop: '4px solid #10b981' }}>
                      <h4 style={{ margin: '0 0 0.6rem 0', color: '#065f46', fontSize: '1.1rem', fontWeight: '800' }}>
                        2. التعليم المتمايز — استجابة متغيّرة بحسب الحاجة
                      </h4>
                      <p style={{ margin: 0, color: '#334155', fontSize: '0.96rem', lineHeight: '1.75' }}>
                        يكيّف المعلم الدعم، ودرجة تعقيد المهمة، وحجم التدريب، ووتيرة العمل، وطرائق التعبير، استنادًا إلى المعلومات المتوافرة عن تعلّم الطلاب. تكون المجموعات ومسارات العمل مرنة؛ مع إتاحة فرص التعمّق والإبداع لكل طالب، وتضمين الأهداف الفردية للطلاب في التخطيط والتقويم مع الحفاظ على الارتباط بالتعلّم المشترك.
                      </p>
                    </div>

                    <div style={{ background: '#f8fafc', padding: '1.4rem', borderRadius: '14px', border: '1px solid #e2e8f0', borderTop: '4px solid #d97706' }}>
                      <h4 style={{ margin: '0 0 0.6rem 0', color: '#92400e', fontSize: '1.1rem', fontWeight: '800' }}>
                        3. التقويم — معلومات توجّه الخطوة التالية في التعلّم
                      </h4>
                      <p style={{ margin: 0, color: '#334155', fontSize: '0.96rem', lineHeight: '1.75' }}>
                        تُجمع خلال المحطات شواهد موجزة على الفهم والأداء. ويستخدمها المعلم والطالب لاتخاذ قرار بشأن مواصلة التعلّم، أو التعمّق، أو تعديل الدعم، أو العودة إلى الشرح والتدريب. يراعي التقويم التقدّم الفردي ومعايير النجاح، وتُوثَّق الإنجازات في المحتوى، والمهارة، والمشاركة بصورة منفصلة للاعتراف بالنجاحات وتحديد الاحتياجات بدقة.
                      </p>
                    </div>
                ...
                <div className="doc-sub-block" style={{ marginTop: '2rem' }}>
                  <h3 className="doc-sub-title">🏛️ المرتكزات التربوية (UDL & SEL)</h3>
                  <div style={{ background: '#eff6ff', padding: '1.3rem 1.6rem', borderRadius: '14px', border: '1px solid #bfdbfe' }}>
                    <p className="doc-paragraph" style={{ margin: '0 0 0.8rem 0' }}>
                      • <strong>التصميم الشامل للتعلّم (UDL):</strong> يستند تخطيط النموذج إلى مبادئ تنويع طرائق الانخراط في التعلّم، وعرض المعلومات وتمثيلها، والأداء والتعبير. وتُوظَّف هذه المبادئ عملياً عبر جميع المحطات.
                    </p>
                    <p className="doc-paragraph" style={{ margin: '0 0 0.8rem 0' }}>
                      • <strong>التعلّم الاجتماعي العاطفي (SEL):</strong> تُدمَج أبعاد الوعي بالذات، وإدارة الذات، ومهارات العلاقات وفق إطار <strong>CASEL</strong>، وتُترجَم في النموذج إلى ممارسات ثابتة للإصغاء، وطلب المساعدة، والتعامل مع الصعوبات، والتعاون الإيجابي.
                    </p>
                    <p style={{ margin: 0, fontSize: '0.92rem', color: '#1e40af', fontWeight: '700' }}>
                      📌 يُطرَح نموذج «مِفتاح» بوصفه إطارًا مدرسيًا متكاملاً للتطبيق والتقويم، ويُفحَص أثره الميداني في مدرسة مشيرفة الابتدائية بصورة مستمرة خلال عملية التبنّي والتنفيذ.
                    </p>
                  </div>
                </div>
              </article>

              {/* CHAPTER 3: المحطات الخمس في نظرة واحدة */}
              <article className="doc-chapter-card" id="doc-sec-glance">
                <div className="chapter-header">
                  <div className="chapter-number-pill">الفصل 3</div>
                  <h2>المحطات الخمس في نظرة واحدة</h2>
                </div>
                  ...
                  <table className="doc-matrix-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'right' }}>
                    <thead>
                      <tr style={{ background: '#0f172a', color: '#ffffff' }}>
                        <th style={{ padding: '14px 16px', borderRadius: '12px 0 0 0', width: '90px', textAlign: 'center' }}>الحرف العبري</th>
                        <th style={{ padding: '14px 16px', minWidth: '200px' }}>المحطة</th>
                        <th style={{ padding: '14px 16px', minWidth: '240px' }}>محور التركيز التفكيري</th>
                        <th style={{ padding: '14px 16px', borderRadius: '0 12px 0 0', minWidth: '260px' }}>سؤال الطالب</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr style={{ borderBottom: '1px solid #e2e8f0', background: '#fffbeb' }}>
                        ...
                        <td style={{ padding: '14px', fontWeight: '800', color: '#92400e' }}>
                          <strong>مدخل محفّز</strong><br />
                          <small style={{ color: '#b45309', fontWeight: '600' }}>משיכה וסקרנות</small>
                        </td>
                        <td style={{ padding: '14px', color: '#334155' }}>
                          استدعاء المعرفة السابقة وطرح الأسئلة
                        </td>
                        <td style={{ padding: '14px', color: '#1e293b', fontWeight: '700' }}>
                          ما الذي يثير فضولي؟ وما الذي نريد استكشافه؟
                        </td>
                      </tr>

                      <tr style={{ borderBottom: '1px solid #e2e8f0', background: '#ecfeff' }}>
                        <td style={{ textAlign: 'center', padding: '14px' }}>
                          <span style={{ background: '#06b6d4', color: '#fff', width: '32px', height: '32px', borderRadius: '50%', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontWeight: '900', fontSize: '1.1rem' }}>פ</span>
                        </td>
                        <td style={{ padding: '14px', fontWeight: '800', color: '#0e7490' }}>
                          <strong>فهم وبناء المعنى</strong><br />
                          <small style={{ color: '#0891b2', fontWeight: '600' }}>פיתוח הבנה</small>
                        </td>
                        <td style={{ padding: '14px', color: '#334155' }}>
                          التذكّر والفهم
                        </td>
                        <td style={{ padding: '14px', color: '#1e293b', fontWeight: '700' }}>
                          ماذا نتعلّم؟ وكيف أشرح الفكرة بكلماتي الخاصة؟
                        </td>
                      </tr>

                      <tr style={{ borderBottom: '1px solid #e2e8f0', background: '#f5f3ff' }}>
                        <td style={{ textAlign: 'center', padding: '14px' }}>
                        ...
                        <td style={{ padding: '14px', fontWeight: '800', color: '#6d28d9' }}>
                          <strong>تفكير وتبصّر</strong><br />
                          <small style={{ color: '#7c3aed', fontWeight: '600' }}>תובנה והעמקה</small>
                        </td>
                        <td style={{ padding: '14px', color: '#334155' }}>
                          التحليل، وفحص الأدلة، وإصدار أحكام معلَّلة
                        </td>
                        <td style={{ padding: '14px', color: '#1e293b', fontWeight: '700' }}>
                          كيف توصّلت إلى الإجابة؟ وما الذي يدعمها؟
                        </td>
                      </tr>
                      ...
                      <tr style={{ borderBottom: '1px solid #e2e8f0', background: '#ecfdf5' }}>
                        ...
                        <td style={{ padding: '14px', fontWeight: '800', color: '#047857' }}>
                          <strong>إنجاز وتطبيق</strong><br />
                          <small style={{ color: '#059669', fontWeight: '600' }}>יצירה ויישום</small>
                        </td>
                        <td style={{ padding: '14px', color: '#334155' }}>
                          التطبيق، والإبداع في المهمات الملائمة
                        </td>
                        <td style={{ padding: '14px', color: '#1e293b', fontWeight: '700' }}>
                          كيف أستخدم ما تعلّمته؟ وما الأدوات التي تساعدني؟
                        </td>
                      </tr>
                      ...
                      <tr style={{ background: '#fdf2f8' }}>
                        ...
                        <td style={{ padding: '14px', fontWeight: '800', color: '#be185d' }}>
                          <strong>حصاد وزوّادة</strong><br />
                          <small style={{ color: '#db2777', fontWeight: '600' }}>חתימה וצידה לדרך</small>
                        </td>
                        <td style={{ padding: '14px', color: '#334155' }}>
                          التقويم الذاتي والتأمل في التعلّم
                        </td>
                        <td style={{ padding: '14px', color: '#1e293b', fontWeight: '700', borderRadius: '0 0 12px 0' }}>
                          فيمَ تقدّمت؟ وما الذي سأحمله معي للمرحلة المقبلة؟
                        </td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                <p style={{ margin: '0.8rem 0 0 0', fontSize: '0.92rem', color: '#64748b', fontStyle: 'italic' }}>
                  💡 توجّه محاور التركيز التفكيري اختيار المهمات، لكنها لا تحصر التفكير في محطة محدّدة. ويمكن التنقّل بين المحطات والعودة إليها بحسب الحاجة.
                </p>
              </article>

              {/* CHAPTER 4: الدليل الإجرائي التفصيلي للمحطات الخمس */}
              <article className="doc-chapter-card" id="doc-sec-stations-detail">
                <div className="chapter-header">
                  <div className="chapter-number-pill">الفصل 4</div>
                  <h2>الدليل الإجرائي التفصيلي للمحطات الخمس</h2>
                </div>
                ...
                <div className="doc-stations-detailed-list">
                  ...
                  <div className="station-doc-card st-card-m" style={{ borderRight: '6px solid #f59e0b' }}>
                    <div className="st-doc-header">
                      <div className="st-doc-title-wrap">
                        <span className="st-doc-tag" style={{ background: '#f59e0b' }}>المحطة الأولى [ م ]</span>
                        <h3 className="st-doc-title" style={{ margin: 0, fontSize: '1.35rem', color: '#92400e' }}>
                          مدخل محفّز | משיכה וסקרנות
                        </h3>
                      </div>
                    ...
                    <p className="doc-paragraph">
                      <strong>هدف المحطة:</strong> إثارة الاهتمام، وتنشيط المعرفة السابقة، وطرح سؤال يرتبط بهدف التعلّم.
                    </p>
                    <p className="doc-paragraph">
                      يعرض المعلم مثيرًا قصيرًا ذا صلة بالموضوع: صورة، أو غرضًا محسوسًا، أو قصة، أو ظاهرة، أو مشكلة، أو خطأ لافتًا. يتأمل الطلاب، ويربطون ما يشاهدونه بمعرفتهم السابقة، ويقترحون أسئلة أو فرضيات.
                    </p>

                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '12px', margin: '1rem 0' }}>
                      <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#1e40af', display: 'block', marginBottom: '0.3rem' }}>🤝 الاحتواء والدمج:</strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155' }}>يُخطَّط لعرض المثير بصورة ميسّرة (صورة مصحوبة بوصف لفظي، أو نص مع استماع). تُتاح الاستجابة بالكلام أو الإشارة أو الرسم أو الحوار الثنائي. والبدء بسؤال: «ماذا لاحظتم؟»، ثم تفسيرات أكثر تعقيدًا.</span>
                      </div>

                      <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#065f46', display: 'block', marginBottom: '0.3rem' }}>🎯 التعليم المتمايز:</strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155' }}>تقديم دعم لغوي، وقت للتفكير، كلمات مساعدة، أو أسئلة متابعة بحسب الحاجة. ودعوة الطلاب المستعدّين للتوسّع إلى تقديم فرضية وتعليلها.</span>
                      </div>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '10px', marginTop: '10px' }}>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#0f172a' }}>📊 التقويم: </span>
                        <span>يصغي المعلم للاستجابات لتحديد المعرفة السابقة والتصورات الأولية وتكييف الشرح اللاحق.</span>
                      </div>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#059669' }}>✅ مؤشر التقدّم: </span>
                        <span>يستطيع الطلاب تحديد الموضوع الذي سيتناولونه أو ما يسعون إلى استكشافه بطريقة تعبير مناسبة لهم.</span>
                      </div>
                    </div>

                    <div style={{ background: '#fffbeb', padding: '0.9rem 1.2rem', borderRadius: '10px', marginTop: '1rem', border: '1px dashed #f59e0b' }}>
                      <strong style={{ color: '#b45309' }}>🗣️ عبارة الانتقال: </strong>
                      <span style={{ fontWeight: '800', color: '#78350f', fontSize: '1.05rem' }}>«انطلاقًا مما طرحتموه، سنحاول اليوم أن نفهم…»</span>
                    </div>
                  </div>

                  {/* STATION 2 */}
                  <div className="station-doc-card st-card-f" style={{ borderRight: '6px solid #06b6d4' }}>
                    <div className="st-doc-header">
                      <div className="st-doc-title-wrap">
                        <span className="st-doc-tag" style={{ background: '#06b6d4' }}>المحطة الثانية [ ف ]</span>
                        <h3 className="st-doc-title" style={{ margin: 0, fontSize: '1.35rem', color: '#0e7490' }}>
                          فهم وبناء المعنى | פיתוח הבנה
                        </h3>
                      </div>
                      <span style={{ background: '#ecfeff', color: '#0e7490', padding: '4px 12px', borderRadius: '20px', fontSize: '0.85rem', fontWeight: '800' }}>
                        سؤال الطالب: ماذا نتعلّم؟ وكيف أشرح الفكرة بكلماتي الخاصة؟
                      </span>
                    </div>

                    <p className="doc-paragraph">
                      <strong>هدف المحطة:</strong> توضيح هدف التعلّم وبناء فهم أوّلي للمفاهيم وطرائق العمل.
                    </p>
                    <p className="doc-paragraph">
                      يعرض المعلم هدف التعلّم بلغة مفهومة، ويُبقيه ظاهرًا، وإلى جانبه معايير نجاح موجزة تصف ما سيتمكّن الطالب من شرحه أو تنفيذه. يشرح المعلم ويقدّم نماذج توضيحية ويُظهر خطوات تفكيره بصوت مسموع (I Do). ويقرأ الطلاب ويستمعون ويجرّبون ويسألون ويشرحون بكلماتهم الخاصة.
                    </p>

                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '12px', margin: '1rem 0' }}>
                      <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#1e40af', display: 'block', marginBottom: '0.3rem' }}>🤝 الاحتواء والدمج:</strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155' }}>تمثيلات متكاملة: شرح لفظي، مخطّط، عرض عملي، أو غرض محسوس. معجم صفي موجز مع مثال أو رمز مساعد على رف المفاتيح. تجزئة التعليمات بوضوح.</span>
                      </div>

                      <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#065f46', display: 'block', marginBottom: '0.3rem' }}>🎯 التعليم المتمايز:</strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155' }}>تكييف عدد الأمثلة وطريقة الإيضاح وتجزئة المهمة إلى خطوات. تقديم مثال محلول، أو بطاقة خطوات، أو شرح إضافي ضمن مجموعة صغيرة.</span>
                      </div>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '10px', marginTop: '10px' }}>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#0f172a' }}>📊 التقويم: </span>
                        <span>طلب شاهد موجز على الفهم من كل طالب (مثال، تصنيف، عرض عملي، شرح) لتحديد من يتابع ومن يحتاج ترسيخاً.</span>
                      </div>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#059669' }}>✅ مؤشر التقدّم: </span>
                        <span>يشرح الطالب الفكرة الأساسية أو يوضّحها عمليًا. وعندما يحتاج مساعدة، يُحدَّد الدعم المناسب.</span>
                      </div>
                    </div>

                    <div style={{ background: '#ecfeff', padding: '0.9rem 1.2rem', borderRadius: '10px', marginTop: '1rem', border: '1px dashed #06b6d4' }}>
                      <strong style={{ color: '#0891b2' }}>🗣️ عبارة الانتقال: </strong>
                      <span style={{ fontWeight: '800', color: '#164e63', fontSize: '1.05rem' }}>«تعرّفنا إلى الفكرة؛ والآن سنفحص كيف تعمل ولماذا»</span>
                    </div>
                  </div>
                  ...
                  <div className="station-doc-card st-card-t" style={{ borderRight: '6px solid #8b5cf6' }}>
                    <div className="st-doc-header">
                      <div className="st-doc-title-wrap">
                        <span className="st-doc-tag" style={{ background: '#8b5cf6' }}>المحطة الثالثة [ ت ]</span>
                        <h3 className="st-doc-title" style={{ margin: 0, fontSize: '1.35rem', color: '#6d28d9' }}>
                          تفكير وتبصّر | תובנה והעמקה
                        </h3>
                      </div>
                      <span style={{ background: '#f5f3ff', color: '#6d28d9', padding: '4px 12px', borderRadius: '20px', fontSize: '0.85rem', fontWeight: '800' }}>
                        سؤال الطالب: كيف توصّلت إلى الإجابة؟ وما الذي يدعمها؟
                      </span>
                    </div>

                    <p className="doc-paragraph">
                      <strong>هدف المحطة:</strong> فحص العلاقات والتفسيرات والأدلة، وتعميق الفهم.
                    </p>
                    <p className="doc-paragraph">
                      يطرح المعلم أسئلة مثل: «كيف توصّلت إلى الاستنتاج؟»، و«ما العلاقة بين الأجزاء؟»، و«ما الدليل الذي يدعم الادّعاء؟»، و«ما الذي سيتغيّر إذا غيّرنا أحد المعطيات؟». يحلّل الطلاب، ويقارنون، ويعلّلون، ويفحصون تفسيرات بديلة.
                    </p>

                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '12px', margin: '1rem 0' }}>
                      <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#1e40af', display: 'block', marginBottom: '0.3rem' }}>🤝 الاحتواء والدمج:</strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155' }}>إتاحة وقت للتفكير الفردي قبل الحوار، العمل في أزواج أو مجموعات ثلاثية، وتوزيع أدوار متناوبة (الباحث عن الأدلة، مقدّم التعليل، المتحدّث) مع تعبير كل طالب عن فهمه الشخصي دون تقييد.</span>
                      </div>

                      <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#065f46', display: 'block', marginBottom: '0.3rem' }}>🎯 التعليم المتمايز:</strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155' }}>أسئلة مساعدة، بطاقات تلميح، منظمات تفكير، وقوالب لصياغة الادعاء والدليل. وفحص ادّعاء مضاد، أو حالة استثنائية، أو تفسير بديل للطلاب المستعدّين للتوسّع.</span>
                      </div>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '10px', marginTop: '10px' }}>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#0f172a' }}>📊 التقويم: </span>
                        <span>فحص جودة التعليل والعلاقة والدليل، والتحقق من فهم كل طالب: «اختاروا دليلًا واحدًا، واشرحوا كيف يدعم الإجابة».</span>
                      </div>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#059669' }}>✅ مؤشر التقدّم: </span>
                        <span>يقدّم الطالب تفسيرًا معلَّلًا أو يبيّن علاقة ذات معنى، مع الدعم المناسب له.</span>
                      </div>
                    </div>

                    <div style={{ background: '#f5f3ff', padding: '0.9rem 1.2rem', borderRadius: '10px', marginTop: '1rem', border: '1px dashed #8b5cf6' }}>
                      <strong style={{ color: '#7c3aed' }}>🗣️ عبارة الانتقال: </strong>
                      <span style={{ fontWeight: '800', color: '#4c1d95', fontSize: '1.05rem' }}>«فحصنا الفكرة وفسّرناها؛ والآن سنستخدمها في المهمة»</span>
                    </div>
                  </div>
                  ...
                  <div className="station-doc-card st-card-y" style={{ borderRight: '6px solid #10b981' }}>
                    <div className="st-doc-header">
                      <div className="st-doc-title-wrap">
                        <span className="st-doc-tag" style={{ background: '#10b981' }}>المحطة الرابعة [ ي ]</span>
                        <h3 className="st-doc-title" style={{ margin: 0, fontSize: '1.35rem', color: '#047857' }}>
                          إنجاز وتطبيق | יצירה ויישום
                        </h3>
                      </div>
                      <span style={{ background: '#ecfdf5', color: '#047857', padding: '4px 12px', borderRadius: '20px', fontSize: '0.85rem', fontWeight: '800' }}>
                        سؤال الطالب: كيف أستخدم ما تعلّمته؟ وما الأدوات التي تساعدني؟
                      </span>
                    </div>

                    <p className="doc-paragraph">
                      <strong>هدف المحطة:</strong> استخدام المعارف والمهارات من خلال التدريب، وحل المشكلات، وإنتاج المخرجات. يعرض المعلم المهمة ومعايير النجاح، ويعمل الطلاب بصورة فردية أو ثنائية أو جماعية، ويشرحون كيفية توظيف ما تعلّموه.
                    </p>

                    <div style={{ background: '#f0fdf4', padding: '1.2rem', borderRadius: '12px', border: '1px solid #bbf7d0', margin: '1rem 0' }}>
                      <h4 style={{ margin: '0 0 0.8rem 0', color: '#166534', fontSize: '1.05rem', fontWeight: '800' }}>
                        🎯 التعليم المتمايز — ثلاثة مسارات عمل مرنة في ورشة التطبيق:
                      </h4>
                      <div style={{ overflowX: 'auto' }}>
                        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'right', fontSize: '0.93rem' }}>
                          <thead>
                            <tr style={{ background: '#dcfce7', color: '#14532d' }}>
                              <th style={{ padding: '8px 12px', width: '150px' }}>المسار</th>
                              <th style={{ padding: '8px 12px' }}>طبيعة العمل</th>
                              <th style={{ padding: '8px 12px' }}>أمثلة على الدعم أو التحدّي</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr style={{ borderBottom: '1px solid #bbf7d0' }}>
                              <td style={{ padding: '8px 12px', fontWeight: '800', color: '#15803d' }}>تطبيق مدعوم</td>
                              <td style={{ padding: '8px 12px' }}>استخدام المعرفة والمهارة بمساندة تعليمية</td>
                              <td style={{ padding: '8px 12px' }}>مثال محلول، بنك كلمات، وسيلة إيضاح، بطاقة خطوات</td>
                            </tr>
                            <tr style={{ borderBottom: '1px solid #bbf7d0' }}>
                              <td style={{ padding: '8px 12px', fontWeight: '800', color: '#15803d' }}>تطبيق مستقل</td>
                              <td style={{ padding: '8px 12px' }}>تنفيذ المهمات الأساسية وفق معايير النجاح</td>
                              <td style={{ padding: '8px 12px' }}>حل، أو كتابة، أو عرض عملي مستقل، مع إمكانية طلب المساعدة</td>
                            </tr>
                            <tr>
                              <td style={{ padding: '8px 12px', fontWeight: '800', color: '#15803d' }}>تعمّق وإبداع</td>
                              <td style={{ padding: '8px 12px' }}>التوسّع، وفحص البدائل، أو إنتاج مخرج جديد</td>
                              <td style={{ padding: '8px 12px' }}>تحليل خطأ، مقارنة حلول، تخطيط، أو دمج أفكار</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      <p style={{ margin: '0.6rem 0 0 0', fontSize: '0.85rem', color: '#166534', fontStyle: 'italic' }}>
                        * لا تمثّل هذه المسارات مجموعات ثابتة؛ بل يُختار المسار بالحوار وتُتاح إمكانية الانتقال والاستعانة بالدعم في مهام التعمق.
                      </p>
                    </div>

                    {/* Table Focus & Return Card */}
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '12px', margin: '1rem 0' }}>
                      <div style={{ background: '#f8fafc', padding: '1.1rem', borderRadius: '10px', border: '1px solid #e2e8f0', borderTop: '3px solid #10b981' }}>
                        <strong style={{ color: '#047857', display: 'block', marginBottom: '0.4rem' }}>
                          🪑 طاولة التدريس المركّز — «محطة الضبط والإتقان»:
                        </strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155', lineHeight: '1.7' }}>
                          أثناء العمل المستقل، يعمل المعلم مع مجموعة صغيرة متغيّرة (4 إلى 6 طلاب) لترسيخ جانب لم يترسخ بعد، بتقديم تمثيل بديل وتدريب موجّه ثم التحقق من الاستقلالية للعودة للمهمة.
                        </span>
                      </div>

                      <div style={{ background: '#f8fafc', padding: '1.1rem', borderRadius: '10px', border: '1px solid #e2e8f0', borderTop: '3px solid #3b82f6' }}>
                        <strong style={{ color: '#1d4ed8', display: 'block', marginBottom: '0.4rem' }}>
                          🏷️ بطاقة «مفتاح العودة إلى الفهم»:
                        </strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155', lineHeight: '1.7' }}>
                          يعرض الطالب بطاقة صغيرة على طاولته عند الحاجة لتوضيح؛ ليقدم المعلم أو الزميل المساند استجابة مناسبة تحفظ كرامة الطالب وتوجهه لمواصلة الإنجاز.
                        </span>
                      </div>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '10px', marginTop: '10px' }}>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#0f172a' }}>📊 التقويم: </span>
                        <span>فحص المنتَج وطريقة الأداء وفق المعايير، مع توثيق نوع الدعم ودرجة الاستقلالية.</span>
                      </div>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#059669' }}>✅ مؤشر التقدّم: </span>
                        <span>يُظهر الطالب استخدامًا لما تعلّمه، ويشرح طريقة عمله.</span>
                      </div>
                    </div>

                    <div style={{ background: '#ecfdf5', padding: '0.9rem 1.2rem', borderRadius: '10px', marginTop: '1rem', border: '1px dashed #10b981' }}>
                      <strong style={{ color: '#047857' }}>🗣️ عبارة الانتقال: </strong>
                      <span style={{ fontWeight: '800', color: '#064e3b', fontSize: '1.05rem' }}>«سنفحص الآن ما نجحنا في إنجازه، وما نريد أن نحمله معنا للمرحلة المقبلة»</span>
                    </div>
                  </div>
                  ...
                  <div className="station-doc-card st-card-h" style={{ borderRight: '6px solid #ec4899' }}>
                    <div className="st-doc-header">
                      <div className="st-doc-title-wrap">
                        <span className="st-doc-tag" style={{ background: '#ec4899' }}>المحطة الخامسة [ ح ]</span>
                        <h3 className="st-doc-title" style={{ margin: 0, fontSize: '1.35rem', color: '#be185d' }}>
                          حصاد وزوّادة | חתימה וצידה לדרך
                        </h3>
                      </div>
                      <span style={{ background: '#fdf2f8', color: '#be185d', padding: '4px 12px', borderRadius: '20px', fontSize: '0.85rem', fontWeight: '800' }}>
                        سؤال الطالب: فيمَ تقدّمت؟ وما الذي سأحمله معي للمرحلة المقبلة؟
                      </span>
                    </div>

                    <p className="doc-paragraph">
                      <strong>هدف المحطة:</strong> العودة إلى الهدف، وتحديد التقدّم، واختيار زوّادة لمواصلة التعلّم.
                    </p>
                    <p className="doc-paragraph">
                      يجيب الطالب عن أسئلة مختارة للتقويم والتأمل الذاتي:
                    </p>

                    <div style={{ background: '#fdf2f8', padding: '1.1rem 1.4rem', borderRadius: '12px', border: '1px solid #fbcfe8', margin: '0.8rem 0' }}>
                      <strong style={{ color: '#9d174d', display: 'block', marginBottom: '0.5rem' }}>🎒 الأسئلة الخمسة للزوّادة والتقويم الذاتي:</strong>
                      <ul style={{ margin: 0, paddingRight: '20px', color: '#831843', lineHeight: '1.85' }}>
                        <li><strong>ماذا تعلّمت أو نجحت في إنجازه اليوم؟</strong></li>
                        <li><strong>ما المثال الذي يدلّ على تقدّمي؟</strong></li>
                        <li><strong>ما الذي ساعدني على التعلّم؟</strong></li>
                        <li><strong>ما الذي ما زال يحتاج إلى تدريب أو شرح؟</strong></li>
                        <li><strong>أين يمكنني استخدام ما تعلّمته؟</strong></li>
                      </ul>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '12px', margin: '1rem 0' }}>
                      <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#1e40af', display: 'block', marginBottom: '0.3rem' }}>🤝 الاحتواء والدمج:</strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155' }}>إتاحة التلخيص بالكتابة، أو الكلام، أو الرسم، أو الاختيار المصحوب بتفسير. والمشاركة الفردية مع المعلم دون إلزام الطالب بكشف صعوبته أمام الصف.</span>
                      </div>

                      <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#065f46', display: 'block', marginBottom: '0.3rem' }}>🎯 التعليم المتمايز:</strong>
                        <span style={{ fontSize: '0.92rem', color: '#334155' }}>تكييف حجم التلخيص والدعم (طالب يستعين ببداية جملة، وطالب يشرح كيف سينقل ما تعلّمه إلى موقف جديد في حياته وبيته).</span>
                      </div>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '10px', marginTop: '10px' }}>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#0f172a' }}>📊 التقويم: </span>
                        <span>فحص الطالب لتقدّمه مقارنةً بنقطة بدايته وبمعايير النجاح، وتخطيط المعلم للخطوة التالية.</span>
                      </div>
                      <div style={{ background: '#f8fafc', padding: '0.8rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <span style={{ fontWeight: '800', color: '#059669' }}>✅ مؤشر التقدّم: </span>
                        <span>يحدّد الطالب ما تعلّمه، ويقدّم شاهدًا عليه، ويشير إلى خطوة لاحقة أو استخدام ممكن.</span>
                      </div>
                    </div>

                    <div style={{ background: '#fdf2f8', padding: '0.9rem 1.2rem', borderRadius: '10px', marginTop: '1rem', border: '1px dashed #ec4899' }}>
                      <strong style={{ color: '#be185d' }}>🗣️ طبيعة الزوّادة: </strong>
                      <span style={{ color: '#831843' }}>قد تكون الزوّادة معرفة، أو مهارة، أو استراتيجية، أو سؤالًا، يُعاد إليها في دروس لاحقة.</span>
                    </div>
                  </div>
              ...
              {/* CHAPTER 5: المرتكزات المشتركة لجميع المحطات ومعايير النجاح */}
              <article className="doc-chapter-card" id="doc-sec-shared">
                <div className="chapter-header">
                  <div className="chapter-number-pill">الفصل 5</div>
                  <h2>المرتكزات المشتركة ومعايير النجاح ثلاثية الأبعاد</h2>
                </div>

                <div className="doc-sub-block">
                  <h3 className="doc-sub-title">🧭 مسار تعلّم واضح ورفّ المفاتيح</h3>
                  <p className="doc-paragraph">
                    • <strong>مسار تعلّم واضح:</strong> تُعرَض المحطات الخمس في كل صف بأسمائها ورموزها المشتركة. ويشرح المعلم الانتقالات وأهدافها، مع إمكانية تكليف طالب بدور «ملّاح التعلّم» ليحدد المحطة أثناء التعلّم المشترك ويشرح ما يُنجَز فيها ولأي غرض.
                  </p>
                  <p className="doc-paragraph">
                    • <strong>رفّ المفاتيح:</strong> تُجمَع في الصف أدوات مساعدة متاحة، مثل معاجم المفاهيم، وبنوك الكلمات، ومنظّمات التفكير، وبطاقات الخطوات، ووسائل الإيضاح، والأدوات التكنولوجية. يتعلّم الطلاب اختيار الأداة بحسب الحاجة وفحص مدى مساعدتها لهم.
                  </p>
                </div>

                <div className="doc-sub-block" style={{ marginTop: '1.5rem' }}>
                  <h3 className="doc-sub-title">📏 معايير النجاح في ثلاثة أبعاد</h3>
                  <div className="doc-table-wrapper" style={{ overflowX: 'auto', margin: '0.8rem 0' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'right' }}>
                      <thead>
                        <tr style={{ background: '#1e293b', color: '#ffffff' }}>
                          <th style={{ padding: '12px 16px', borderRadius: '10px 0 0 0', width: '160px' }}>البُعد</th>
                          <th style={{ padding: '12px 16px', width: '220px' }}>السؤال الموجِّه</th>
                          <th style={{ padding: '12px 16px', borderRadius: '0 10px 0 0' }}>مثال تطبيقي</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr style={{ borderBottom: '1px solid #e2e8f0', background: '#f8fafc' }}>
                          <td style={{ padding: '12px 16px', fontWeight: '800', color: '#1e40af' }}>المحتوى</td>
                          <td style={{ padding: '12px 16px', color: '#334155' }}>ماذا سيفهم الطالب؟</td>
                          <td style={{ padding: '12px 16px', color: '#0f172a' }}>يشرح مفهومًا ويقدّم مثالًا مناسبًا عليه</td>
                        </tr>
                        <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                          <td style={{ padding: '12px 16px', fontWeight: '800', color: '#065f46' }}>المهارة</td>
                          <td style={{ padding: '12px 16px', color: '#334155' }}>ماذا سيتمكّن الطالب من تنفيذه؟</td>
                          <td style={{ padding: '12px 16px', color: '#0f172a' }}>يحدّد دليلًا ويربطه بالادّعاء</td>
                        </tr>
                        <tr style={{ background: '#f8fafc' }}>
                          <td style={{ padding: '12px 16px', fontWeight: '800', color: '#92400e' }}>المشاركة</td>
                          <td style={{ padding: '12px 16px', color: '#334155' }}>كيف سيكون شريكًا في التعلّم؟</td>
                          <td style={{ padding: '12px 16px', color: '#0f172a' }}>يتفاعل مع فكرة زميل أو يساهم بطريقة متَّفق عليها</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  <p style={{ margin: '0.5rem 0 0 0', fontSize: '0.9rem', color: '#64748b' }}>
                    * تُختار في كل درس معايير قليلة وذات صلة. وتُفحَص المشاركة بطرائق ميسّرة (مساهمة مكتوبة، حوار ثنائي) وليس فقط من خلال التحدّث أمام الصف.
                  </p>
                </div>

                <div className="doc-sub-block" style={{ marginTop: '1.5rem' }}>
                  <h3 className="doc-sub-title">🤝 ممارسات انفعالية واجتماعية والتخطيط المشترك</h3>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '12px' }}>
                    <div style={{ background: '#ffffff', padding: '1.1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                      <strong style={{ color: '#0f172a', display: 'block', marginBottom: '0.3rem' }}>ممارسات انفعالية واجتماعية ثابتة:</strong>
                      <span style={{ fontSize: '0.92rem', color: '#475569', lineHeight: '1.7' }}>تُدرَّس بصورة صريحة طرائق طلب التوضيح، والاختلاف باحترام، وتلقّي التغذية الراجعة، والعودة إلى المهمة بعد مواجهة صعوبة، مع إتاحة مكان هادئ للعمل عند الحاجة.</span>
                    </div>
                    <div style={{ background: '#ffffff', padding: '1.1rem', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
                      <strong style={{ color: '#0f172a', display: 'block', marginBottom: '0.3rem' }}>التخطيط المشترك بين الطاقم:</strong>
                      <span style={{ fontSize: '0.92rem', color: '#475569', lineHeight: '1.7' }}>عند وجود معلم إضافي أو مساند، يُحدَّد مسبقًا هدف التعلّم، وتوزيع أدوار التدريس والملاحظة والمساندة مع الحفاظ على مشاركة الطالب في التعلّم الصفي.</span>
                    </div>
                  </div>
                </div>
              </article>

              {/* CHAPTER 6: أدوات العمل وخطة التطبيق والعبارة الموجهة */}
              <article className="doc-chapter-card" id="doc-sec-tools-plan">
                <div className="chapter-header">
                  <div className="chapter-number-pill">الفصل 6</div>
                  <h2>أدوات العمل المدرسية وخطة التطبيق (8 أسابيع)</h2>
                </div>

                <div className="doc-sub-block">
                  <h3 className="doc-sub-title">🧰 أدوات العمل المدرسية</h3>
                  <div className="doc-table-wrapper" style={{ overflowX: 'auto', margin: '0.8rem 0' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'right' }}>
                      <thead>
                        <tr style={{ background: '#1e293b', color: '#ffffff' }}>
                          <th style={{ padding: '12px 16px', borderRadius: '10px 0 0 0', width: '220px' }}>الأداة</th>
                          <th style={{ padding: '12px 16px', borderRadius: '0 10px 0 0' }}>وظيفتها الميدانية</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                          { tool: 'مسار «مِفتاح» في الصف', role: 'عرض المحطات وتوضيح عملية التعلّم ومساره للطلاب' },
                          { tool: 'نموذج تخطيط مشترك', role: 'تخطيط الهدف، والمحطات، والعوائق المتوقَّعة، والاستجابات، وشواهد النجاح' },
                          { tool: 'رفّ المفاتيح', role: 'إتاحة أدوات الدعم والمساندة للاختيار الموجَّه من قبل الطلاب' },
                          { tool: 'مسارات مهمات مرنة', role: 'مواءمة الدعم والتحدّي (مدعوم، مستقل، تعمّق وإبداع)' },
                          { tool: 'طاولة التدريس المركّز', role: 'ترسيخ الفهم والتدريب ضمن مجموعة متغيّرة («محطة الضبط والإتقان»)' },
                          { tool: 'بطاقة «مفتاح العودة إلى الفهم»', role: 'طلب التوضيح وتوجيه المساعدة وحفظ كرامة الطالب' },
                          { tool: 'دفتر «زوّادتي»', role: 'توثيق التقدّم الفردي والخطوة اللاحقة ونقل أثر التعلم' },
                          { tool: 'أداة للملاحظة والتغذية الراجعة', role: 'فحص جودة التدريس والمشاركة والتعلّم المشترك' }
                        ].map((row, idx) => (
                          <tr key={idx} style={{ borderBottom: '1px solid #e2e8f0', background: idx % 2 === 0 ? '#f8fafc' : '#ffffff' }}>
                            <td style={{ padding: '11px 16px', fontWeight: '800', color: '#1e40af' }}>{row.tool}</td>
                            <td style={{ padding: '11px 16px', color: '#334155' }}>{row.role}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  ...
                  <div style={{ background: '#f8fafc', padding: '1.2rem', borderRadius: '12px', border: '1px solid #e2e8f0', marginTop: '1rem' }}>
                    <strong style={{ color: '#0f172a', display: 'block', marginBottom: '0.4rem' }}>
                      📋 أسئلة المعلم الأربعة الإلزامية في نموذج التخطيط عند كل محطة:
                    </strong>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '8px' }}>
                      <span style={{ background: '#ffffff', padding: '8px 12px', borderRadius: '8px', border: '1px solid #cbd5e1', fontWeight: '700', color: '#1e3a8a' }}>1. ماذا سيفعل الطالب؟</span>
                      <span style={{ background: '#ffffff', padding: '8px 12px', borderRadius: '8px', border: '1px solid #cbd5e1', fontWeight: '700', color: '#991b1b' }}>2. ما الذي قد يعيق مشاركته؟</span>
                      <span style={{ background: '#ffffff', padding: '8px 12px', borderRadius: '8px', border: '1px solid #cbd5e1', fontWeight: '700', color: '#065f46' }}>3. ما المواءمة أو الاختيار المتاح؟</span>
                      <span style={{ background: '#ffffff', padding: '8px 12px', borderRadius: '8px', border: '1px solid #cbd5e1', fontWeight: '700', color: '#92400e' }}>4. ما الشاهد على تقدّمه؟</span>
                    </div>
                  </div>
                </div>

                <div className="doc-sub-block" style={{ marginTop: '2rem' }}>
                  <h3 className="doc-sub-title">📅 خطة مقترحة للتبنّي والتطبيق — ثمانية أسابيع</h3>
                  <div className="doc-table-wrapper" style={{ overflowX: 'auto', margin: '0.8rem 0' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'right' }}>
                      <thead>
                        <tr style={{ background: '#0f172a', color: '#ffffff' }}>
                          <th style={{ padding: '12px 16px', borderRadius: '10px 0 0 0', width: '180px' }}>الفترة</th>
                          <th style={{ padding: '12px 16px', borderRadius: '0 10px 0 0' }}>محور العمل الميداني</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr style={{ borderBottom: '1px solid #e2e8f0', background: '#f8fafc' }}>
                          <td style={{ padding: '12px 16px', fontWeight: '800', color: '#2563eb' }}>الأسبوعان 1–2</td>
                          <td style={{ padding: '12px 16px', color: '#334155' }}>خوض الطاقم تجربة عملية للنموذج، والاتفاق على دلالات المحطات، وتحديد العوائق، وتجهيز المسار الصفي</td>
                        </tr>
                        <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                          <td style={{ padding: '12px 16px', fontWeight: '800', color: '#2563eb' }}>الأسبوعان 3–4</td>
                          <td style={{ padding: '12px 16px', color: '#334155' }}>التطبيق في دروس مختارة؛ توضيح الأهداف والانتقالات ومعايير النجاح، وإرساء ممارسات طلب المساعدة</td>
                        </tr>
                        <tr style={{ borderBottom: '1px solid #e2e8f0', background: '#f8fafc' }}>
                          <td style={{ padding: '12px 16px', fontWeight: '800', color: '#2563eb' }}>الأسبوعان 5–6</td>
                          <td style={{ padding: '12px 16px', color: '#334155' }}>تخطيط مهمات متمايزة وطرائق تعبير متنوّعة، وتفعيل طاولة التدريس ورفّ المفاتيح</td>
                        </tr>
                        <tr>
                          <td style={{ padding: '12px 16px', fontWeight: '800', color: '#2563eb' }}>الأسبوعان 7–8</td>
                          <td style={{ padding: '12px 16px', color: '#334155' }}>ملاحظات صفية متبادلة بين الزملاء، وحوارات مع الطلاب، وفحص المخرجات بهدف تحسين النموذج</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div className="doc-sub-block" style={{ marginTop: '2rem' }}>
                  <h3 className="doc-sub-title">🔍 كيف نفحص تقدّم عملية التطبيق؟</h3>
                  <div style={{ background: '#f8fafc', padding: '1.3rem 1.6rem', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
                    <p style={{ margin: '0 0 0.8rem 0', fontWeight: '700', color: '#334155' }}>
                      نجمع المعلومات من خلال التخطيط، والملاحظات الصفية القصيرة، والحوارات، ومخرجات الطلاب، ونفحص ما يأتي:
                    </p>
                    <ol style={{ margin: 0, paddingRight: '22px', color: '#1e293b', lineHeight: '2', fontSize: '0.98rem' }}>
                      <li>هل يستخدم المعلمون والطلاب المحطات بدلالات مشتركة؟</li>
                      <li>هل يفهم الطلاب الهدف والعلاقة بين النشاط والتعلّم؟</li>
                      <li>من يشارك؟ وبأي طريقة؟ ومن ما زال يحتاج إلى طريقة إضافية للمشاركة؟</li>
                      <li>هل تلائم الاستجابات العوائق التي جرى التعرّف إليها؟</li>
                      <li>هل ينتقل الطلاب بين المسارات والمجموعات بحسب الحاجة؟</li>
                      <li>هل توجد شواهد على التقدّم في الفهم والأداء والاستقلالية؟</li>
                      <li>هل يعرف الطلاب كيف يطلبون المساعدة ويشرحون ما الذي ساعدهم؟</li>
                      <li>هل يستخدم المعلمون المعلومات التي جُمعت لتخطيط الخطوة التالية؟</li>
                    </ol>
                  </div>
                </div>

                {/* LEADING MOTTO BANNER */}
                <div style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0284c7 100%)', color: '#ffffff', borderRadius: '18px', padding: '2rem', textAlign: 'center', marginTop: '2.5rem', boxShadow: '0 10px 30px rgba(15, 23, 42, 0.25)' }}>
                  <div style={{ fontSize: '2rem', marginBottom: '0.6rem' }}>🗝️ ✨ 🗝️</div>
                  <h3 style={{ margin: '0 0 0.6rem 0', fontSize: '1.25rem', color: '#38bdf8', fontWeight: '800' }}>العبارة الموجِّهة للنموذج</h3>
                  <p style={{ margin: '0 0 1.2rem 0', fontSize: 'clamp(1.3rem, 3vw, 1.8rem)', fontWeight: '900', color: '#ffffff', textShadow: '0 2px 10px rgba(0,0,0,0.4)' }}>
                    «مِفتاح — مسار تعلّم مشترك، وطرائق متنوّعة للمشاركة والتقدّم.»
                  </p>
                  
                  <div style={{ background: 'rgba(255, 255, 255, 0.12)', padding: '1rem 1.5rem', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.2)', display: 'inline-block', maxWidth: '750px' }}>
                    <span style={{ display: 'block', fontSize: '0.9rem', color: '#fed7aa', fontWeight: '800', marginBottom: '0.3rem' }}>بلغة الطلاب:</span>
              ...
              <div className="doc-paper-footer-nav no-print">
                <div className="dpf-text">
                  ...
                  <span>تم استعراض الوثيقة البيداغوجية الكاملة لنموذج «مِفتاح» (מודל מפתיח). يمكنك الآن البدء بهندسة حصتك وتوليد الخطة الذكية.</span>
                </div>
                    ...
                    <div className="robot-plan-result">
                      ...
                      <div className="generated-stations-list">
                        <div className="gen-station-card yellow">
                          ...
                          <div className="station-pillars-tags">
                            <span className="st-pillar-badge inclusion"><i className="fas fa-hands-helping"></i> הכלה והשתלבות</span>
                            <span className="st-pillar-badge diff"><i className="fas fa-layer-group"></i> דיפרנציאליות</span>
                            <span className="st-pillar-badge eval"><i className="fas fa-check-circle"></i> הערכה ומחוון</span>
                          </div>
                        ...
                        <div className="gen-station-card pink">
                          ...
                          <div className="station-pillars-tags">
                            <span className="st-pillar-badge inclusion"><i className="fas fa-hands-helping"></i> הכלה והשתלבות</span>
                            <span className="st-pillar-badge diff"><i className="fas fa-layer-group"></i> דיפרנציאליות</span>
                            <span className="st-pillar-badge eval"><i className="fas fa-check-circle"></i> הערכה ومחוון</span>
                          </div>
