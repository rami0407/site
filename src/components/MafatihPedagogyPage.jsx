...
1. الاحتواء والدمج (لكل طالب مكان ومساهمة): مداخل ميسّرة، تمثيلات متعددة UDL، بدائل تعبيرية، حوار ثنائي، وحفظ كرامة الطالب.
2. التعليم المتمايز (استجابة متغيّرة بحسب الحاجة): 3 مسارات عمل مرنة في الورشة (مدعوم، مستقل، تعمّق وإبداع)، طاولة التدريس المركّز («محطة الضبط والإتقان» 4-6 طلاب)، وبطاقة «مفتاح العودة إلى الفهم».
3. التقويم (معلومات توجّه الخطوة التالية): شواهد فهم موجزة ومؤشرات تقدم، ومعايير نجاح في 3 أبعاد (المحتوى، المهارة، المشاركة).
...
[ ح ] حصاد وزوّادة (חתימה וצידה لדרך) — التقويم الذاتي عبر الأسئلة الخمسة وتحديد الزوّادة ومقولة الطالب: «أعرف ما أتعلّمه، وأجد طريقة للمشاركة، وأطلب المساعدة حين أحتاج إليها، وأُظهر كيف تقدّمت».

أجب المعلم بخطوات إجرائية ونماذج وأسئلة واقعية قابلة للتطبيق الصفي الفوري وفق هذا النموذج.`;
