...
const LearningCorner = () => {
  ...
  const GEO_QUESTIONS = [
    {
      id: 'g1',
      question: 'ما هي عاصمة دولة فلسطين التاريخية والخالدة التي تضم المسجد الأقصى المبارك؟',
      icon: '🕌',
      imageUrl: 'https://images.unsplash.com/photo-1544971587-b842c27f8c14?auto=format&fit=crop&w=600&q=80',
      choices: ['القدس الشريف 🇵🇸', 'عَمّان 🇯🇴', 'القاهرة 🇪🇬', 'بيروت 🇱🇧'],
      correctIndex: 0,
      fact: 'القدس الشريف هي زهرة المدائن وعاصمة فلسطين التاريخية والدينية الخالدة.'
    },
    {
      id: 'g2',
