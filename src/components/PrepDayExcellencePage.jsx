  ...
  return (
    <div className="prep-day-container">
      ...
      <div className="prep-header">
        <span className="prep-badge">🌟 اليوم التحضيري 2026 - مدرسة مشيرفة</span>
        <h1>🎨 صفحة التميز لليوم التحضيري</h1>
        <p>
          شاركونا إبداعاتكم ورسماتكم! قم بالتقاط صورة لرسمتك أو اعد رسمها رقمياً لتظهر مباشرة أمام الجميع في معرض التميز وشاشة العرض الكبيرة.
        </p>
