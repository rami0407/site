...
export const generateMafatihLessonPlanAI = async ({
  ...
  const prompt = `أنت الخبير البيداغوجي والمستشار التعليمي الأول لموديل "مِفْتَاح" (מודל מַפְתֵּי"חַ) بمدرسة مشيرفة الابتدائية.
...
${isSEL ? `
❤️ توجيه جوهري ملزم للمجال العاطفي والاجتماعي (SEL - Social-Emotional Learning):
بما أن هذا الدرس يقع في المجال العاطفي والاجتماعي، يجب أن تكون خطة الدرس ونوعية النصوص والأنشطة ملائمة 100% لهذا العالم الوجداني:
1. نوعية النص والمحتوى: قصة وجدانية مؤثرة، أو سيناريو سلوكي واجتماعي واقعي يلامس مشاعر الطلاب وصراعاتهم اليومية في المدرسة والبيت، بعيداً عن النصوص التقريرية الجافة.
2. [ م ] المدخل المحفّز (משיכה וסקרנות): ابدأ بمحفز وجداني وحسي ملامس للقلب (مثل فحص الطقس الداخلي للمشاعر Emotional Weather، أو قارورة الهدوء، أو معضلة أخلاقية وإنسانية تمس كرامة الطفل وعلاقاته) مع سؤال إشعال وجداني صريح يثير الفضول والأمان النفسي.
3. [ ف ] فهم وبناء المعنى (פיתוח הבנה): اكتب النص الوجداني/الحواري النموذجي بالكامل، واشرح كلمات قاموس المشاعر بدقة (تسمية المشاعر: مثل التوتر، الغبطة، الخيبة، التعاطف، الصمود النفسي)، ونمذجة المعلم (I Do) للتفكير الانفعالي الإيجابي والاستماع المتفهم.
4. [ ت ] التفكير والتبصّر (תובנה והעמקה): اكتب 3 أسئلة تفكير عليا في الذكاء العاطفي لتبني منظور الآخر (Perspective Taking)، والتمييز بين رد الفعل الاندفاعي والاستجابة الواعية، وتحليل الاحتياجات الإنسانية وراء السلوكيات.
5. [ ي ] الإنجاز والتطبيق (יצירה ויישום): ورشة لعب أدوار ومحاكاة مواقف واقعية (Role-Play)، أو ميثاق الأمان النفسي، أو شجرة المودة وصندوق المشاعر، مع مسارات تمايز للتعبير الآمن.
6. [ ح ] الحصاد والزوّادة (חתימה וצידה לדרך): تذكرة خروج وجدانية وزوّادة قلبية سلوكية ينقل الطالب أثرها لبيته وأسرته (لفتة تعاطف، كلمة طيبة، تمرين تهدئة عند الغضب).` : ''}
...
1. [ م ] محطة المدخل المحفّز (משיכה וסקרנות): اكتب نص اللغز أو السيناريو الواقعي الحقيقي بالكامل، مع سؤال الإشعال الصريح بالحرف الواحد الذي يوجهه المعلم للطلاب لإثارة دهشتهم وفضولهم دون حرق الحل وكسر الجمود.
2. [ ف ] محطة فهم وبناء المعنى (פיתוח הבנה): اكتب النص التعليمي النموذجي الحقيقي بالكامل أو المسألة بالأرقام والخطوات، واكتب كلمات القاموس اللغوي والعلمي وتفسيرها، واشرح نمذجة المعلم (I Do) بتطبيق حي واضح لتطوير الفهم وبناء المعنى.
3. [ ت ] محطة التفكير والتبصّر (תובנה והעמקה): اكتب 3 أسئلة تفكير عليا (HOTS) حقيقية ومكتوبة بنصها الصريح تخص موضوع الدرس مباشرة وتدعو للمقارنة والتعليل والنقد والتبصر العميق.
4. [ ي ] محطة الإنجاز والتطبيق (יצירה ויישום): اكتب نص مهمة ورشة العمل ومسارات التمايز الثلاثة (مسار الدعم، المسار الأساسي، مسار التحدي) بنصوص وتمارين وأمثلة حقيقية قابلة للتنفيذ في الصف لتحقيق إنجاز ملموس.
5. [ ح ] محطة الحصاد والزوّادة (חתימה וצידה לדרך): اكتب نص تذكرة الخروج وسؤال نقل الأثر الحياتي الذي سيطبقه الطالب اليوم في بيته ومع عائلته بنصه الكامل.
...
أخرج النتيجة بصيغة JSON حصراً بهذا المخطط بدون أي زيادات:
{
  ...
  "stations": {
    "m": "نص محطة المدخل المحفّز الكامل والمحدد بنصه الفعلي...",
    "f": "نص محطة فهم وبناء المعنى الكامل مع النص والقاموس والنمذجة...",
    "t": "نص محطة التفكير والتبصّر مع أسئلة التفكير العليا الصريحة...",
    "y": "نص محطة الإنجاز والتطبيق مع مسارات التمايز والتمارين الحقيقية...",
    "h": "نص محطة الحصاد والزوّادة مع تذكرة الخروج والزوّادة الحياتية الصريحة..."
  }
}`;
